...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://dx1xq84dhi.execute-api.us-east-1.amazonaws.com/dev2';
    ...
    apigClient.uploadBucketFilenamePut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'x-amz-meta-customLabels', 'bucket', 'Content-Type'], ['body']);
